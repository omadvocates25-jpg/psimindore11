...
function renderRandProfile(){
 ...
 if(!currentUser){ box.innerHTML='<div class="text-center py-6"><p class="text-5xl mb-3">🔒</p><p class="font-bold text-gray-600">Please Register to view profiles</p></div>'; return; }
